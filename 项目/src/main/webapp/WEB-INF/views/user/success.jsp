...
<div class="container">
    <div class="row clearfix">
        ...
        <div class="col-md-4 column">
            <a href="/index.jsp" class="btn btn-primary btn-lg" role="button" style="padding-top: 100px">注册成功，点击返回主页</a>
        </div>
        <div class="col-md-4 column">
        </div>
    <%--<a type="button" href="/index.jsp" class="btn btn-default btn-lg">返回主页</a>--%>
    <%--<a type="button" href="/user/toEdit" class="btn btn-info btn-lg">返回个人信息</a>--%>

    <%--<a href="/user/toEdit/${user.user_id}" class="btn btn-primary btn-lg" role="button">返回个人信息</a>--%>
</div>
