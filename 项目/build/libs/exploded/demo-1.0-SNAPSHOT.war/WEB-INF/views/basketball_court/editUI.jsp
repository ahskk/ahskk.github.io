...
<div class="container">
    <div class="row clearfix">
        <div class="col-md-4 column">
            <hr>
            <h3><a href="/basketball_court/toManage_main" class="label label-success label-default">返回管理主页</a></h3>
            <hr>
            <h3><a href="/basketball_court/manage" class="label label-success label-default">返回篮球场管理</a></h3>
        </div>
        <div class="col-md-4 column" style="background-color: #f9f9f9">
            ...
            <form class="form-horizontal" role="form" method="post"
                  action="/basketball_court/doUpdate" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="court_name" class="col-sm-4 control-label">球场名称</label>
                    <div class="col-sm-8">
                        <%--隐藏id--%>
                        <input type="text" name="court_id" value="${basketball_court.court_id}" hidden>
                        <%--<input type="text" name="sellerID" value="${sessionScope.seller.id}" hidden>--%>
                        <input type="text" class="form-control" id="court_name"
                               placeholder="请输入球场名称" name="court_name" value="${basketball_court.court_name}"
                        >
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" id="court_price"
                               placeholder="请输入场地单价" name="court_price" value="${basketball_court.court_price}"
                        >
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-0 col-sm-12 btn-block">
                        <c:choose>
                            <c:when test="${empty basketball_court.category_id}">
