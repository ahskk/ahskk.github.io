        ...
        <c:forEach items="${content.data}" var="b">
            <c:forEach items="${content.cdata}" var="c">
                <tr>
                    ...
                    <td>${b.court_price}</td>
                    <td>
                        <a href="/basketball_court/toEdit/${b.court_id}"
                           class="label label-danger large">修改
                        </a>
                    </td>
                    <td>
                        <a href="/basketball_court/delete/${b.court_id}"
...
<%--数据展示表格结束--%>
<h3>
    <a href="/basketball_court/toEdit" class="label label-success label-lg">添加</a>
</h3>
            ...
            <dl id="basketball_court_detail" class="floatleft showtab" style="display:block;background-color: #f9f9f9">
                <form method="post" name="form1">
                    ...
                    <dd>
                        ...
                        <span class="floatleft">6 号场</span>

                        <span class="floatleft sp0">
					<input type="hidden" name="cxptime_6" value="1"/>
				</span>
                        <span class="floatleft sp0">
					<input type="hidden" name="cxptime_6" value="1"/>
				</span>
...
//                        window.location.href = "/booking/booking_message";
                            window.location.href = "/basketball_court/manage";
                        } else {
