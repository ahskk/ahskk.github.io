    ...
    <table class="table table-hover table-striped">
        ...
        <c:forEach items="${content.data}" var="b">
            ...
            <tr>
                ...
                <td>${b.court_price}</td>
                <td>
                    <a href="/tennis_court/toEdit/${b.court_id}"
                       class="label label-danger large">修改
                    </a>
                </td>
                <td>
                    <a href="/tennis_court/delete/${b.court_id}"
...
<%--数据展示表格结束--%>
<h3>
    <a href="/tennis_court/toEdit" class="label label-success label-lg">添加</a>
</h3>
...
//                        window.location.href = "/booking/booking_message";
                            window.location.href = "/tennis_court/manage";
                        } else {
