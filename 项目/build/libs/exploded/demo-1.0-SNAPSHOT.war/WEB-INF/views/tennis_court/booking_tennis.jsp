...
<div class="container">
    <div class="row clearfix">
        ...
        <div class="col-md-7 column" style="background-color: #f9f9f9">
            ...
            <dl id="tennis_court_detail" class="floatleft showtab" style="display:block;background-color: #f9f9f9">
...
//        alert(curDate);
        $.ajax({
            ...
            error: function () {
                alert("查询出错了");
                // $("#tennis_court_detail").html("查询出错了");
            },
...
//                        alert("123");
                                ...
                                window.location.href = "/tennis_court/booking_tennis";
                            }
                        },
